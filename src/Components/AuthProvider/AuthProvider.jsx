...
const AuthProvider = ({ children }) => {
    ...
    const logOut = ()=>{
        ...
        axios.post('https://pis-server.vercel.app/logout',loggedUser,{withCredentials :true})
           .then(res=>{
     ...
     useEffect(()=>{
        const unSubscribe = onAuthStateChanged(auth,currentUser =>{
            ...
            if(currentUser){
                ...
                axios.post('https://pis-server.vercel.app/jwt' ,loggedUser,{withCredentials :true})
                 .then(res=>{
